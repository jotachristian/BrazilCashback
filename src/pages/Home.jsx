    ...
    <div className="flex gap-4 justify-center md:justify-start">
      ...
      <a href="/contato">
        ...
        <div className="md:w-1/2 w-full flex justify-center md:mt-0 mx-15">
          <img src={Gestao} alt="Boneco-mexendo-em-arquivos" className="max-w-96 h-auto mt-10" />
        </div>
      </div>
        ...
        {[
          {
            ...
            review: "Não consigo mais comprar nada sem dar uma espiadinha antes no Brazil Cashback! Foi amor a primeira cash."
          },
          {
            name: "Bruno Santos",
          ...
          {
            name: "Carla Lima",
            review: "Cara eu AMO fazer compras online e usar o Cashback, é tão legal depois você olhar o app e do nada ter uns dinheirinhos na carteira e você ainda tem cupons de desconto.",
          },
          {
            name: "Diego Costa",
