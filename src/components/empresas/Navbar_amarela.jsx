    ...
    >
      <div className="flex justify-between items-center px-10 md:px-8">
        ...
        <div className="flex-grow flex justify-center md:justify-start">
          <a href= "/para_empresas" className="flex">
            <img
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <a
            href="/entrar_empresa"
            className={`text-base rounded-md px-4 pb-2 transition duration-300 bg-primary text-black font-bold hover:text-gray-500`}
          >
            Entrar
          </a>
        </div>
        ...
        {menuOpen && (
          <div className="fixed top-0 left-0 w-full h-full bg-white dark:bg-gray-800 flex z-50">
            <div className="w-3/4 h-full flex flex-col pt-5 pl-4">
              <button
                onClick={toggleMenu}
                className="bg-transparent text-left text-lg text-gray-400 mb-2 p-2"
              >
                Voltar
              </button>
              <a
                href="/"
                className="text-[#ffcc00] text-lg py-4 w-full"
                onClick={toggleMenu}
              >
                Para você
              </a>
              ...
              <a
                href="/entrar_empresa"
                className="text-[#ffcc00] text-lg my-4 w-full"
                onClick={toggleMenu}
              >
                Entrar
              </a>
            ...
            <div
              className="w-1/4 h-full bg-transparent/70"
              onClick={toggleMenu}
            ></div>
          </div>
        )}
